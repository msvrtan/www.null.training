...
class WorkshopSessionIdSpec extends ObjectBehavior
{
    public function let()
    {
    ...
    {
        $this->shouldHaveType(WorkshopSessionId::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(WorkshopSessionId::class);
    }
}
